...
FINAL_DIR=/video-conf/scratch/pantea_tardy/final_results/vpx
MAIN_CONFIG_DIR=/data1/pantea/aiortc/nets_implementation/first_order_model/config/paper_configs/exps_overview/vpx
for person in "adam_neely" "xiran" "fancy_fueko" "needle_drop" "kayleigh";
do
    for setting in lr128_tgt15Kb lr256_tgt45Kb lr256_tgt75Kb lr512_tgt180Kb lr512_tgt420Kb
    do
