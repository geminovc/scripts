...
# main plot
python collect_results_from_ml_pipeline.py --approaches-to-compare main_exp:SwinIR main_exp:fomm main_exp:bicubic main_exp:vp9_bicubic main_exp:ours main_exp:vpx main_exp:vp9_ours main_exp:vp9 --base-dir-list /video-conf/scratch/pantea_tardy/final_results/swinir /video-conf/scratch/vibhaa_lam2/final_results/model_comparisons /video-conf/scratch/pantea_tardy/final_results/bicubic  /video-conf/scratch/vibhaa_tardy/vp9/bicubic /video-conf/scratch/vibhaa_tardy/final_results/training_with_encoder/ /video-conf/scratch/pantea_tardy/final_results/vpx /video-conf/scratch/vibhaa_lam2_new/vp9_summary_before_recalibrating /video-conf/scratch/vibhaa_tardy/vp9/vp9  --person-list needle_drop fancy_fueko adam_neely kayleigh xiran  --people-for-strip kayleigh xiran needle_drop fancy_fueko --save-prefix ../data/full_comparison_with_vp9_after_recalibrating --csv-name summary.csv --img-width 1024 --video-num 2 --frame-num 1634  --summarize
# data was wrangled to remove "ours" for 75Kb and 105Kb and replace with "vp9_ours", and remaining rows of "vp9_ours" were removed and saved in wrangled_summary.csv
./main_comparison.R
...
./quality_cdf_main_exp.R ../data/full_comparison_with_vp9_after_recalibrating/frame_cdf.csv pdfs/main_experiment_with_vp9_after_recalibrating_per_frame_cdf_3plots_ssim.pdf ssim_db
...
# model ablation
python collect_results_from_ml_pipeline.py --approaches-to-compare model_ablation --base-dir-list /video-conf/scratch/vibhaa_lam2/final_results/model_comparison_with_encoder  --person-list kayleigh xiran fancy_fueko needle_drop adam_neely  --people-for-strip kayleigh needle_drop xiran --save-prefix ../data/model_ablation_with_encoder_only_2_approaches --csv-name summary.csv --img-width 1024 --video-num 2 --frame-num 839 --summarize

# model ablation cdf
python collect_results_from_ml_pipeline.py --approaches-to-compare model_ablation --base-dir-list /video-conf/scratch/vibhaa_lam2/final_results/model_comparison_with_encoder  --person-list kayleigh xiran fancy_fueko needle_drop adam_neely  --people-for-strip kayleigh needle_drop xiran --save-prefix ../data/model_ablation_with_encoder_only_2_approaches --csv-name video_cdf.csv --img-width 1024 --video-num 2 --frame-num 839 --cdf --per-video
python collect_results_from_ml_pipeline.py --approaches-to-compare model_ablation --base-dir-list /video-conf/scratch/vibhaa_lam2/final_results/model_comparison_with_encoder  --person-list kayleigh xiran fancy_fueko needle_drop adam_neely  --people-for-strip kayleigh needle_drop xiran --save-prefix ../data/model_ablation_with_encoder_only_2_approaches  --csv-name frame_cdf.csv --img-width 1024 --video-num 2 --frame-num 839 --cdf
./quality_cdf_model_ablation.R ../data/model_ablation_with_encoder_only_2_approaches/frame_cdf.csv ../data/model_ablation_with_encoder_only_2_approaches/video_cdf.csv pdfs/model_ablation_combined_videos_frames_cdf.pdf


# personalization effect (both strip and table)
# Gemino
python collect_results_from_ml_pipeline.py --approaches-to-compare personalization --base-dir-list /video-conf/scratch/vibhaa_mm_log_directory/personalization/  --person-list kayleigh jen_psaki trevor_noah seth_meyers needle_drop --people-for-strip needle_drop seth_meyers jen_psaki --save-prefix ../data/personalization_after_bug_fix --csv-name summary.csv --img-width 512 --video-num 2 --frame-num 1952 --summarize
# up-sampling
...
# appendix figures
for person in "fancy_fueko" "xiran" "needle_drop" "kayleigh"; 
    do
    python collect_results_from_ml_pipeline.py --approaches-to-compare main_exp:bicubic main_exp:vp9_bicubic main_exp:ours main_exp:vpx main_exp:vp9_ours main_exp:vp9 --base-dir-list /video-conf/scratch/pantea_tardy/final_results/bicubic /video-conf/scratch/vibhaa_tardy/vp9/bicubic /video-conf/scratch/vibhaa_tardy/final_results/training_with_encoder/ /video-conf/scratch/pantea_tardy/final_results/vpx /video-conf/scratch/vibhaa_lam2_new/vp9_summary_before_recalibrating /video-conf/scratch/vibhaa_tardy/vp9/vp9  --person-list ${person}  --people-for-strip ${person} --save-prefix ../data/full_comparison_with_vp9_after_recalibrating --csv-name dummy.csv --img-width 1024 --video-num 2 --frame-num 637  --summarize
done
