...
--root-dir /video-conf/scratch/pantea/fom_personalized_1024 \
--people needle_drop kayleigh xiran fancy_fueko adam_neely \
--save-prefix /data3/pantea/nsdi_fall_2022/bicubic_full_range_quantizer_logs_256_and_512 \
--executable-dir /data4/pantea/aiortc/examples/videostream-cli \
--csv data/nsdi_fall_2022_bicubic_full_range_quantizer_all_ppl_3_videos_256_and_512 \
...
--root-dir /video-conf/scratch/pantea/fom_personalized_1024 \
--people needle_drop kayleigh xiran fancy_fueko adam_neely \
--save-prefix /data3/pantea/nsdi_fall_2022/bicubic_full_range_quantizer_logs_64_and_128  \
--executable-dir /data4/pantea/aiortc/examples/videostream-cli \
--csv data/nsdi_fall_2022_bicubic_full_range_quantizer_all_ppl_3_videos_64_and_128 \
--quantizer-list 32 --lr-quantizer-list -1 \
--lr-target-bitrate-list 15000 45000 \
--video-num-range 0 2 --disable-mahimah --use_bicubic \

python aggregate_approach_comparison_data.py \
--data-paths data/nsdi_fall_2022_bicubic_full_range_quantizer_all_ppl_3_videos_256_and_512 data/nsdi_fall_2022_bicubic_full_range_quantizer_all_ppl_3_videos_64_and_128 \
--settings Bicubic Bicubic \
...
--csv-name /data3/pantea/nsdi_fall_2022/bicubic_full_range_quantizer_aggregate.csv \
