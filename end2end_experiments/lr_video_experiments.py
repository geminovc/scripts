...
parser.add_argument('--lr-target-bitrate-list', type=int, nargs='+',
                    help='list of target vpx bitrate levels for low-res to run on (assumes bps)',
                    default=[100000])
                ...
                for quantizer in args.quantizer_list:
                    for lr_quantizer in args.lr_quantizer_list:
                        for lr_target_bitrate in args.lr_target_bitrate_list:
                            params['lr_target_bitrate'] = lr_target_bitrate
                            ...
                            params['save_dir'] = f'{args.save_prefix}/lrresolution{lr_resolution}/{person}/' + \
                                ...
                                f'lr_target_bitrate{lr_target_bitrate}'
                            ...
                            print(f'lr_target_bitrate: {lr_target_bitrate}')
                            start = perf_counter()
            ...
            for lr_quantizer in args.lr_quantizer_list:
                for lr_target_bitrate in args.lr_target_bitrate_list:
                    ...
                    if len(combined_df) > 0:
                        ...
                        mean_df['lr_target_bitrate'] = lr_target_bitrate
